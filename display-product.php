<?php
require 'C:\xampp\htdocs\mcademo2\class\atclass.php';
...
<body class="cbp-spmenu-push">
	...
	<?php
    include 'C:\xampp\htdocs\mcademo2\thempart\sidebar.php';
    ?>
		<!--left-fixed -navigation-->
		
		<!-- header-starts -->
	<?php
    include 'C:\xampp\htdocs\mcademo2\thempart\header-menu.php';
    ?>
		<!-- //header-ends -->
		<!-- main content start-->
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h2 class="title1">Product Tables</h2>
						...
						<table class="table">
                            ...
                            if(isset($_GET['did']))
                            {
                                ...
                                while($productrow = mysqli_fetch_array($selectq))
                                {
                                    ...
                                    echo "<td> <a href='edit-product.php?eid={$productrow['pro_id']}'><img style='width:16px;' img src='myimages/edit.png'>Edit</a> |<a href='display-product.php?did={$productrow['pro_id']}'><img style='width:16px;' img src='myimages/delete.png'> Delete</a></td>";
                                    echo "</tr>";
                                }
                            ?>
		...
		<!--footer-->
	<?php
    include 'C:\xampp\htdocs\mcademo2\thempart\footer.php';
    ?>
        <!--//footer-->
	</div>
