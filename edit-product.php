...
if($_POST)
{
	...
	$query = mysqli_query($connection,"update tbl_product set pro_name='{$pname}',pro_price='{$pprice}',pro_details='{$pdetails}' where pro_id='{$editid}'") or die(mysqli_error($connection));
